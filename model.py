...
class DecoderBlock(nn.Module):
    def __init__(
        self, self_attention_block, cross_attention_block, feed_forward_block
    ) -> None:
        super().__init__()
        self.self_attention_block = self_attention_block
...
class Transformer(nn.Module):
    ...
    def decode(self, encoder_output, src_mask, tgt, tgt_mask):
        ...
        return self.encoder(tgt, encoder_output, src_mask, tgt, tgt_mask)
